      ...
      <div class="relative" use:focusOutside={{ onFocusOut: closeSearchTypeDropdown }}>
        <Button
          ...
          class="px-3 py-1 text-xs {searchStore.isSearchEnabled
            ...
            : 'border-secondary/5 border font-light text-muted hover:text-dark dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white'}"
