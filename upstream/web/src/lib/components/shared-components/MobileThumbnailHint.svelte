...
{#if isMobile && !dismissed}
  <div
    role="status"
    class="pg-mobile-hint flex items-center gap-2 border-b border-white/10 bg-(--md-sys-color-surface-container) px-3 py-1.5 text-(--md-sys-color-on-surface-variant)"
  >
